...
describe('NestJS API compatibility', { concurrency: false }, () => {
  ...
  test('admin claim, JWT auth, settings, and admin listing work', async () => {
    ...
    assert.match(imageEmbed.text, /property="og:image" content="http:\/\/localhost:8080\/file\/preview\/raw"/)
    assert.match(imageEmbed.text, /property="og:image:secure_url" content="http:\/\/localhost:8080\/file\/preview\/raw"/)
    ...
    assert.match(gifEmbed.text, /property="og:image" content="http:\/\/localhost:8080\/file\/animated\/raw"/)
    ...
    assert.match(videoEmbed.text, /property="og:video" content="http:\/\/localhost:8080\/file\/clip\/raw"/)
